...
public:
    ...
    simple_adapted_function<&ssl_api::engine_get_first, owned_engine()>
      get_first_engine{*this};

    simple_adapted_function<&ssl_api::engine_get_last, owned_engine()>
      get_last_engine{*this};

    simple_adapted_function<
      &ssl_api::engine_get_next,
      owned_engine(owned_engine&)>
      get_next_engine{*this};

    simple_adapted_function<
      &ssl_api::engine_get_prev,
      owned_engine(owned_engine&)>
      get_prev_engine{*this};

    simple_adapted_function<&ssl_api::engine_new, owned_engine()> new_engine{
      *this};

    simple_adapted_function<&ssl_api::engine_by_id, owned_engine(string_view)>
      open_engine{*this};
    ...
    simple_adapted_function<
      &ssl_api::engine_free,
      c_api::collapsed<int>(owned_engine)>
      delete_engine{*this};

    simple_adapted_function<&ssl_api::engine_init, c_api::collapsed<int>(engine)>
      init_engine{*this};

    simple_adapted_function<
      &ssl_api::engine_finish,
      c_api::collapsed<int>(engine)>
      finish_engine{*this};

    simple_adapted_function<&ssl_api::engine_get_id, string_view(engine)>
      get_engine_id{*this};

    simple_adapted_function<&ssl_api::engine_get_name, string_view(engine)>
