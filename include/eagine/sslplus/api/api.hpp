...
public:
    ...
    using _message_digest_final_t = c_api::adapted_function<
    ...
    using _message_digest_final_ex_t = c_api::adapted_function<
    ...
    using _message_digest_sign_init_t = c_api::adapted_function<
